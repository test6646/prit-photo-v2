...
export default function Landing() {
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute top-6 left-1/2 -translate-x-1/2 text-[11px] md:text-[15px] tracking-[0.25em] uppercase whitespace-nowrap z-30 text-[var(--text-muted)]"
            >
                AHMEDABAD • INDIA • {time}
            </div>
            ...
            <div className="flex md:hidden flex-col items-center justify-center w-full h-full px-[6vw] gap-6">
                ...
                <div className="relative w-full h-[15vh]">
                    ...
                    {images.map((src, i) => (
                        ...
                        <img
                            ...
                            src={src}
                            className="absolute w-[70px] h-[90px] object-cover rounded-[3px] shadow-2xl will-change-transform"
                            style={{
                                top: ["10%", "60%", "35%", "70%"][i],
                                left: ["20%", "70%", "50%", "10%"][i],
                ...
                <p
                    className="text-[14px] md:text-[16px] leading-[1.6] text-center text-[var(--text-muted)] max-w-[320px]"
                >
                ...
                <div
                    className="flex items-center justify-center gap-6 text-[var(--text-muted)]"
                >
                        ...
                        <svg viewBox="0 0 200 200" className="absolute w-full h-full animate-spin-slow">
                            ...
                            <text fill="var(--text)" fontSize="12" letterSpacing="5">
                                <textPath href="#circlePath-m">
                                    SEE OUR WORK • SEE OUR WORK • SEE OUR WORK •
                                </textPath>
                            </text>
            ...
            >
                ...
                <h1 className="text-[8.5vw] leading-[0.85] uppercase text-[var(--text)]">PRIT</h1>
                <h1 className="text-[8.5vw] leading-[0.85] uppercase text-[var(--text)]">PHOTO</h1>

            </div>


            <p
                className="hidden md:block absolute text-[14px] md:text-[16px] leading-relaxed text-[var(--text-muted)]"
                style={{ bottom: "30vh", left: "6vw", maxWidth: "340px" }}
            >
                We capture fleeting moments and turn them into timeless memories —
                from intimate portraits to unforgettable weddings.
            </p>
            ...
            <div
                className="absolute bottom-[48px] left-[48px] hidden md:flex items-center gap-6"
